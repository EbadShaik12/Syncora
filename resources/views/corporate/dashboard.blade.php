        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
            <div class="flex-1">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black font-outfit leading-tight mb-4 text-slate-900 dark:text-white">
                    Hi, <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-200 dark:to-pink-200">{{ auth()->user()->name }}</span> 👋
                </h1>
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('corporate.swipe') }}" class="magnetic bg-slate-900 hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-purple-700 px-8 py-4 rounded-xl font-bold shadow-md hover:scale-[1.02] transition flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        Discover Startups
                    </a>
                    <a href="{{ route('corporate.challenges.create') }}" class="magnetic border border-slate-200 dark:border-white/30 text-slate-700 dark:text-white bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 px-8 py-4 rounded-xl font-bold hover:scale-[1.02] transition flex items-center gap-2">
    ...
    <div class="grid lg:grid-cols-3 gap-8 stagger-container">
        ...
        <div class="space-y-8">
            ...
            <div class="reveal glass-card-strong rounded-3xl p-8">
                ...
                @php $earnedBadges = auth()->user()->badges; @endphp
                ...
                @if($earnedBadges->count() > 0)
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-4 p-3 rounded-2xl bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/10 dark:to-orange-900/10 border border-yellow-200/60 dark:border-yellow-800/30 hover:border-yellow-400 transition card-lift">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-bold text-gray-900 dark:text-white text-sm truncate">{{ $badge->name }}</p>
