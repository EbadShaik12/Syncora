@extends('layouts.app')
@section('title', 'Kanban Board - ' . $challenge->title)
@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 animate-fade-in" 
     x-data="{
        applications: @js($applications->map(function($app) {
            return [
                'id' => $app->id,
        ...
        <div class="max-w-3xl">
            ...
            <div class="flex items-center gap-2 mb-3 flex-wrap">
                ...
                <span class="text-xs font-semibold px-3 py-1 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400">
                    Budget Pool: ₹{{ number_format($challenge->budget_min) }} – ₹{{ number_format($challenge->budget_max) }}
                </span>
            </div>

            <h1 class="text-3xl font-black text-gray-900 dark:text-white font-outfit mb-2">
                Pipeline: <span class="text-gradient from-purple-500 to-pink-500">{{ $challenge->title }}</span>
            </h1>
