...
<head>
    ...
    <title>@yield('title', 'StartupConnect') - {{ config('app.name') }}</title>
...
<footer class="mt-auto border-t border-gray-200/60 dark:border-gray-800/60 bg-white/50 dark:bg-gray-900/50 backdrop-blur-md relative z-10 py-6 mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium">© {{ date('Y') }} StartupConnect. Built to accelerate innovation.</p>
