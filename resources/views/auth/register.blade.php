...
<div class="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
    ...
    <div class="w-full max-w-4xl relative z-10 stagger-container">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            {{-- Startup Card --}}
            <a href="{{ route('register.startup') }}" class="reveal reveal-delay-2 group tilt-card glass-card-strong rounded-[2.5rem] p-8 border-glow hover:border-blue-500/50 transition-colors duration-300 relative overflow-hidden">
            ...
            {{-- Corporate Card --}}
            <a href="{{ route('register.corporate') }}" class="reveal reveal-delay-3 group tilt-card glass-card-strong rounded-[2.5rem] p-8 border-glow hover:border-purple-500/50 transition-colors duration-300 relative overflow-hidden">
        ...
        <div class="reveal reveal-delay-4 text-center mt-12 font-medium text-gray-500 dark:text-gray-400">
            ...
            <a href="{{ route('login') }}" class="text-primary-600 font-bold hover:underline ml-1">Sign in instead</a>
        </div>
