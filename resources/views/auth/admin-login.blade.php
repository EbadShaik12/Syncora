        ...
        <div class="reveal reveal-delay-1 rounded-3xl p-8 shadow-2xl relative overflow-hidden border border-amber-500/20"
            ...
            <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-5">
                ...
                <div class="input-group">
                    <input type="email" name="email" id="admin_email" value="{{ old('email') }}" required autofocus placeholder=" "
            ...
            <div class="mt-6 pt-6 border-t border-white/5 text-center">
                <p class="text-gray-500 text-sm">Not an admin?
                    <a href="{{ route('login') }}" class="text-amber-400 font-bold hover:text-amber-300 transition">Regular Login →</a>
                </p>
                <p class="text-gray-600 text-xs mt-3">
                    Need an admin account?
                    <a href="{{ route('admin.register') }}" class="text-gray-500 hover:text-amber-400 font-semibold transition">Register here</a>
                </p>
            </div>
        </div>
