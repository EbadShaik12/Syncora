        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
            <div class="flex-1">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black font-outfit leading-tight mb-4 text-glow">
                    Hi, <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-indigo-200"><?php echo e(auth()->user()->name); ?></span> 👋
                </h1>
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('startup.swipe')); ?>" class="magnetic shimmer-btn bg-white text-blue-700 px-8 py-4 rounded-2xl font-bold shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:scale-105 transition flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        Discover Partners
                    </a>
                    <a href="<?php echo e(route('startup.challenges')); ?>" class="magnetic glass-card border border-white/30 text-white px-8 py-4 rounded-2xl font-bold hover:bg-white/10 transition flex items-center gap-2">
                            ...
                            <div class="relative pl-8">
                                ...
                                <div class="bg-white/50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 rounded-2xl p-4 flex items-center gap-4 hover:border-orange-400 transition card-lift">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-orange-500 font-bold text-sm"><?php echo e($badge->name); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
