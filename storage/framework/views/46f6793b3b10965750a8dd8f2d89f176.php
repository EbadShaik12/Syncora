<?php $__env->startSection('title', 'Register as Startup'); ?>
...
<div class="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden bg-transparent">
    ...
    <div class="w-full max-w-4xl relative z-10 stagger-container grid lg:grid-cols-5 gap-8 items-start mt-8">
        ...
        <div class="lg:col-span-2 lg:sticky lg:top-24 text-center lg:text-left reveal">
            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-gray-500 dark:text-gray-400 hover:text-blue-600 transition mb-8 magnetic">
        ...
        <div class="lg:col-span-3 reveal reveal-delay-2 glass-card-strong rounded-3xl p-8 shadow-2xl border-glow">
            <form method="POST" action="<?php echo e(route('register.startup')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-group">
                            <select name="stage" id="stage" required class="w-full rounded-xl border border-gray-200 dark:border-gray-700/50 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 outline-none transition text-gray-900 dark:text-white appearance-none">
                                <option value="idea" <?php echo e(old('stage') == 'idea' ? 'selected' : ''); ?>>Idea / Pre-seed</option>
                                <option value="mvp" <?php echo e(old('stage') == 'mvp' ? 'selected' : ''); ?>>MVP / Seed</option>
                                <option value="growth" <?php echo e(old('stage') == 'growth' ? 'selected' : ''); ?>>Growth / Series A</option>
                                <option value="scale" <?php echo e(old('stage') == 'scale' ? 'selected' : ''); ?>>Scaling / Series B+</option>
                            </select>
                    ...
                    <div class="input-group mt-2">
                        <textarea name="elevator_pitch" id="elevator_pitch" rows="3" required minlength="20" maxlength="1000" placeholder=" "
                            class="w-full rounded-xl border border-gray-200 dark:border-gray-700/50 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 outline-none transition resize-none text-gray-900 dark:text-white"><?php echo e(old('elevator_pitch')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\startup-corporate-platform\resources\views\auth\register-startup.blade.php ENDPATH**/ ?>