<?php $__env->startSection('title', 'Join Syncora'); ?>
...
<div class="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
    ...
    <div class="absolute top-8 left-8 z-20 reveal">
        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-slate-600 dark:text-zinc-400 border border-slate-200/60 dark:border-zinc-800 bg-white/60 dark:bg-zinc-900/60 hover:bg-slate-100 dark:hover:bg-zinc-800/80 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-zinc-700 transition-all shadow-sm hover:scale-105 backdrop-blur-md">
