...
<div class="max-w-3xl mx-auto px-4 py-8 relative z-10 animate-fade-in">
    ...
    <form method="POST" action="<?php echo e(route('corporate.challenges.store')); ?>" enctype="multipart/form-data" data-warn-unsaved class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="glass-card-strong rounded-3xl p-8 border-glow space-y-6">
            <div>
                ...
                <input type="text" name="title" required value="<?php echo e(old('title')); ?>" placeholder="e.g. Next-Gen Generative AI Recommendation System" 
                ...
                <div>
                    ...
                    <select name="industry_id" required 
                        ...
                        <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($i->id); ?>" <?php echo e(old('industry_id') == $i->id ? 'selected' : ''); ?>><?php echo e($i->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="deadline" required value="<?php echo e(old('deadline')); ?>" 
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 focus:border-purple-500 dark:focus:border-purple-500/80 focus:ring-1 focus:ring-purple-500 outline-none text-gray-900 dark:text-white font-medium transition duration-200">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" rows="6" required placeholder="Describe the corporate challenge in detail, including the exact core issues and goals..." 
                          class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 focus:border-purple-500 dark:focus:border-purple-500/80 focus:ring-1 focus:ring-purple-500 outline-none text-gray-900 dark:text-white font-medium transition duration-200"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="requirements" rows="4" placeholder="Detail any mandatory stack requirements, certifications, timeline rules, or team sizes..." 
                          class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 focus:border-purple-500 dark:focus:border-purple-500/80 focus:ring-1 focus:ring-purple-500 outline-none text-gray-900 dark:text-white font-medium transition duration-200"><?php echo e(old('requirements')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="budget_min" min="0" required value="<?php echo e(old('budget_min', 0)); ?>" 
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 focus:border-purple-500 dark:focus:border-purple-500/80 focus:ring-1 focus:ring-purple-500 outline-none text-gray-900 dark:text-white font-medium transition duration-200">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="budget_max" min="0" required value="<?php echo e(old('budget_max', 0)); ?>" 
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 focus:border-purple-500 dark:focus:border-purple-500/80 focus:ring-1 focus:ring-purple-500 outline-none text-gray-900 dark:text-white font-medium transition duration-200">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="required_tags" value="<?php echo e(old('required_tags')); ?>" placeholder="e.g. AI, Python, Docker, PyTorch" 
                       class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60 focus:border-purple-500 dark:focus:border-purple-500/80 focus:ring-1 focus:ring-purple-500 outline-none text-gray-900 dark:text-white font-medium transition duration-200">
