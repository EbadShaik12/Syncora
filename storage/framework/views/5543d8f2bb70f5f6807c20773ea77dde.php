    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 relative">
            ...
            <div class="flex items-center flex-shrink-0">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 group transition duration-300 hover:scale-[1.02]">
                    ...
                    <img src="<?php echo e(asset('images/logo-text.png')); ?>" class="h-6 w-auto object-contain dark:invert transition-all duration-300 hidden sm:block" alt="Syncora Text">
                </a>
            </div>
            ...
            <div class="hidden md:flex flex-1 justify-center items-center">
                <div class="flex items-center gap-2">
                    ...
                    <?php elseif(auth()->user()->isCorporate()): ?>
                        ...
                        <a href="<?php echo e(route('corporate.challenges.index')); ?>" class="nav-link <?php echo e(request()->routeIs('corporate.challenges.*', 'corporate.challenges') ? 'nav-link-active' : ''); ?>">Challenges</a>
                    <?php elseif(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.dashboard*') ? 'nav-link-active' : ''); ?>">📊 Analytics</a>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.users.*') ? 'nav-link-active' : ''); ?>">👥 Users</a>
                        <a href="<?php echo e(route('admin.moderation.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.moderation.*') ? 'nav-link-active' : ''); ?>">🛡️ Moderation</a>
                        <a href="<?php echo e(route('admin.industries.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.industries.*') ? 'nav-link-active' : ''); ?>">🏷️ Industries</a>
                        <a href="<?php echo e(route('admin.badges.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.badges.*') ? 'nav-link-active' : ''); ?>">🏅 Badges</a>
                        <a href="<?php echo e(route('admin.reports.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.reports.*') ? 'nav-link-active' : ''); ?>">📁 Reports</a>
                    <?php endif; ?>
                    <?php if (! (auth()->user()->isAdmin())): ?>
                        ...
                        <a href="<?php echo e(route('leaderboard')); ?>" class="nav-link <?php echo e(request()->routeIs('leaderboard*') ? 'nav-link-active' : ''); ?>">🏆 Ranks</a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.outside="open = false" x-cloak
                        ...
                        <a href="<?php echo e(route('notifications.index')); ?>" class="block text-center py-3 text-[10px] font-black text-primary-600 border-t border-slate-100 dark:border-zinc-800/50 uppercase tracking-widest hover:bg-slate-50 dark:hover:bg-zinc-850">View all</a>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open"
                        ...
                        id="user-menu-button">
                        <div class="relative">
                            <?php if(auth()->user()->profile() && auth()->user()->profile()->logo): ?>
                                <img src="<?php echo e(auth()->user()->logoUrl()); ?>" class="w-9 h-9 rounded-xl object-cover ring-2 ring-white dark:ring-zinc-800 shadow transition group-hover:scale-105">
                            <?php else: ?>
                    ...
                    <div x-show="open" @click.outside="open = false" x-cloak
                        ...
                        <div style="
                            <?php if(auth()->user()->isStartup()): ?> background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%);
                            <?php elseif(auth()->user()->isCorporate()): ?> background: linear-gradient(135deg, #2563eb 0%, #06b6d4 100%);
                            <?php else: ?> background: linear-gradient(135deg, #d97706 0%, #ef4444 100%); <?php endif; ?>
                            padding: 18px 20px;">
                            <div style="display:flex; align-items:center; gap:14px;">
                                <?php if(auth()->user()->profile() && auth()->user()->profile()->logo): ?>
                                    <img src="<?php echo e(auth()->user()->logoUrl()); ?>"
                                ...
                                <div style="min-width:0;flex:1;">
                                    <p style="font-weight:800;color:#ffffff;font-size:15px;line-height:1.3;margin:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                        <?php echo e(auth()->user()->companyName()); ?>
                        ...
                        <div style="padding:8px;">
                            <?php if(auth()->user()->isStartup()): ?>
                                <a href="<?php echo e(route('startup.profile.edit')); ?>" @click="open = false"
                                ...
                                <a href="<?php echo e(route('startup.applications')); ?>" @click="open = false"
                                   style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s ease;"
                                   onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'">
                            ...
                            <?php elseif(auth()->user()->isCorporate()): ?>
                                <a href="<?php echo e(route('corporate.profile.edit')); ?>" @click="open = false"
                                   style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s ease;"
                                   onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'">
                                ...
                                <a href="<?php echo e(route('corporate.challenges.index')); ?>" @click="open = false"
                                   style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s ease;"
                                   onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'">
                            ...
                            <?php elseif(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" @click="open = false"
                                   style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s ease;"
                                   onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'">
                                ...
                                <a href="<?php echo e(route('admin.users.index')); ?>" @click="open = false"
                                   style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s ease;"
                                   onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'">
                            ...
                            <?php if (! (auth()->user()->isAdmin())): ?>
                            <a href="<?php echo e(route('notifications.index')); ?>" @click="open = false"
                               style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s ease;"
                               onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'">
        ...
        <div x-show="mobileOpen" x-cloak x-transition class="md:hidden pb-4 border-t border-slate-100 dark:border-white/5 pt-4 space-y-1 px-2 bg-white/95 dark:bg-[#0d0d12]/95 backdrop-blur-xl">
            <?php if(auth()->user()->isStartup()): ?>
                <a href="<?php echo e(route('startup.dashboard')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('startup.dashboard*') ? 'true' : 'false'); ?> }">Dashboard</a>
                <a href="<?php echo e(route('startup.swipe')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('startup.swipe*') ? 'true' : 'false'); ?> }">Discover</a>
                <a href="<?php echo e(route('startup.challenges')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('startup.challenges*') ? 'true' : 'false'); ?> }">Challenges</a>
            <?php elseif(auth()->user()->isCorporate()): ?>
                <a href="<?php echo e(route('corporate.dashboard')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('corporate.dashboard*') ? 'true' : 'false'); ?> }">Dashboard</a>
                <a href="<?php echo e(route('corporate.swipe')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('corporate.swipe*') ? 'true' : 'false'); ?> }">Discover</a>
                <a href="<?php echo e(route('corporate.challenges.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('corporate.challenges.*', 'corporate.challenges') ? 'true' : 'false'); ?> }">Challenges</a>
            <?php elseif(auth()->user()->isAdmin()): ?>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('admin.dashboard*') ? 'true' : 'false'); ?> }">📊 Analytics</a>
                <a href="<?php echo e(route('admin.users.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('admin.users.*') ? 'true' : 'false'); ?> }">👥 Users</a>
                <a href="<?php echo e(route('admin.moderation.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('admin.moderation.*') ? 'true' : 'false'); ?> }">🛡️ Moderation</a>
                <a href="<?php echo e(route('admin.industries.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('admin.industries.*') ? 'true' : 'false'); ?> }">🏷️ Industries</a>
                <a href="<?php echo e(route('admin.badges.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('admin.badges.*') ? 'true' : 'false'); ?> }">🏅 Badges</a>
                <a href="<?php echo e(route('admin.reports.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('admin.reports.*') ? 'true' : 'false'); ?> }">📁 Reports</a>
            <?php endif; ?>
            <?php if (! (auth()->user()->isAdmin())): ?>
                <div class="h-px bg-slate-100 dark:bg-zinc-800 my-2 mx-3"></div>
                <a href="<?php echo e(route('search')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('search*') ? 'true' : 'false'); ?> }">Search</a>
                <a href="<?php echo e(route('chat.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('chat.*') ? 'true' : 'false'); ?> }">Messages</a>
                <a href="<?php echo e(route('leaderboard')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('leaderboard*') ? 'true' : 'false'); ?> }">Ranks</a>
                <a href="<?php echo e(route('notifications.index')); ?>" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': <?php echo e(request()->routeIs('notifications.*') ? 'true' : 'false'); ?> }">Notifications</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\user\Desktop\startup-corporate-platform\resources\views\components\navbar.blade.php ENDPATH**/ ?>